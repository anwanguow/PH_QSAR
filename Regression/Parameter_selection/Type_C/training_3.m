% 1. Set file paths
save_model = 'models/reg_deg_dist_30.mat';  % The saved model file
load_pca_datafile = 'data_pca/reg_deg_dist_30_pca.csv';  % PCA processed data file
results_file = 'results/reg_deg_dist_30.csv';  % Path to save predictions and true values as CSV file
fig_file = "results/reg_deg_dist_30.png";
