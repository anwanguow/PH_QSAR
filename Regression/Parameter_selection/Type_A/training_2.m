% 1. Set file paths
save_model = 'models/reg_barcode_20.mat';  % The saved model file
load_pca_datafile = 'data_pca/reg_barcode_20_pca.csv';  % PCA processed data file
results_file = 'results/reg_barcode_20.csv';  % Path to save predictions and true values as CSV file
fig_file = "results/reg_barcode_20.png";
