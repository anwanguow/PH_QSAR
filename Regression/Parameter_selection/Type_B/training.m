...
% 1. Set file paths
save_model = 'models/reg_type_b_' + string(number_) + '.mat';  % The saved model file
load_pca_datafile = 'data_pca/reg_type_b_' + string(number_) + '_pca.csv';  % PCA processed data file
results_file = 'results/reg_type_b_' + string(number_) + '.csv';  % Path to save predictions and true values as CSV file
fig_file = 'results/reg_type_b_' + string(number_) + '.png';
